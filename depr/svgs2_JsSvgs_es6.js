...
const svgParser = rawSvg => {
    return Object.assign(canReadDirectory(), canCreateJavascriptSvg(rawSvg));
};

const directoryUtility = () => {
    return Object.assign({}, canReadDirectory(), canCreateDirectory());
};
...
let listOfSvgFilepaths = directoryUtility()
    .readDirectory("./../svgs/jobs_icons/")
    .fileType("svg");
let listOfSvgs = svgParser()
    .parseListOfSvgs(listOfSvgFilepaths)
    .svgObjects();
